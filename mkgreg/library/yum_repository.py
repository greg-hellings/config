...
class YumRepo(object):
    ...
    def add(self):
        ...
        # defined.
        if (self.params['baseurl'], self.params['mirrorlist'],
                self.params['metalink']) == (None, None, None):
            self.module.fail_json(
                msg='Parameter "baseurl" or "mirrorlist" or "metalink" is '
                'required for adding a new repo.')
...
def main():
    ...
    if state == 'present':
        if (
                ...
                module.params['mirrorlist'] is None and
                module.params['metalink'] is None):
            module.fail_json(
                msg="Parameter 'baseurl' or 'mirrorlist' or 'metalink' is "
                    "required.")
